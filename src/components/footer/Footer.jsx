    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__container">
          ...
          <p style={{ fontSize: "var(--fs-xs)", color: "rgba(255,255,255,0.4)", textAlign: "center" }}>
          ...
          >
            <i className="uil uil-instagram" style={{ fontSize: "1.125rem" }}></i>
            @runfornation.id
          </a>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.625rem" }}>
            <span style={{ fontSize: "var(--fs-xs)", color: "rgba(255,255,255,0.3)" }}>
              Website dibuat oleh
            </span>
            <a
            ...
            >
              ...
              <div style={{ textAlign: "left" }}>
                <div style={{ fontSize: "var(--fs-sm)", fontWeight: 700, color: "#fff", lineHeight: 1.2 }}>
                  Griya IT Nusantara
                </div>
                <div style={{ fontSize: "var(--fs-xs)", color: "rgba(255,255,255,0.45)", lineHeight: 1.2 }}>
